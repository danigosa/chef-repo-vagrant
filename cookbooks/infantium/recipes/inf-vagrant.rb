...
execute "Psql template1 to UTF8" do
    ...
    SQL
    only_if '[ $(echo "select count(*) from pg_database where datname = \'template1\' and datcollate = \'de_DE.utf8\'" |psql postgres -t) -eq 0 ]'
end
...
script "setup-postgresql" do
  ...
  psql infantiumdb < /vagrant/database/infantiumdb_dump_chef.dump
  EOH
  action :run
end
